...
public class Adapter_PriceList extends BaseAdapter implements Filterable {
    Context context;
    ...
    public Adapter_PriceList(Context applicationContext, List<Product_model> listProducts) {
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
      ...
      //  holder.p_qty.setText(listProducts.get(i).get_p_Qty() + "");
        ...
        holder.p_price.setText(listProducts.get(i).get_PRICERATE() + " "+listProducts.get(i).get_UOM());
        return view;
    }
