 ...
 * Usage:
 *
 * int sampleInt = SharedPreferencesSingletonStringKey.getInstance(context).getInt(Key.SAMPLE_INT);
 * SharedPreferencesSingletonStringKey.getInstance(context).set(Key.SAMPLE_INT, sampleInt);
 *
 * If SharedPreferencesSingletonStringKey.getInstance(Context) has been called once, you can
 * simple use SharedPreferencesSingletonStringKey.getInstance() to save some precious line space.
 */

public class SharedPreferencesSingletonStringKey {
    // TODO: CHANGE THIS TO SOMETHING MEANINGFUL
    private static final String SETTINGS_NAME = "default_settings";
    private static SharedPreferencesSingletonStringKey sSharedPrefs;
    ...
    public static class Key {
        ...
        public static final String UserID = "a_sample_key" ;
        public static final String CustomerID = "" ;
    }

    private SharedPreferencesSingletonStringKey(Context context) {
        mPref = context.getSharedPreferences(SETTINGS_NAME, Context.MODE_PRIVATE);
    }


    public static SharedPreferencesSingletonStringKey getInstance(Context context) {
        if (sSharedPrefs == null) {
            sSharedPrefs = new SharedPreferencesSingletonStringKey(context.getApplicationContext());
        }
        return sSharedPrefs;
    }

    public static SharedPreferencesSingletonStringKey getInstance() {
        if (sSharedPrefs != null) {
            return sSharedPrefs;
        }
